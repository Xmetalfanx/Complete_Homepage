...
<footer class="row m-0">
  ...
  <div class="col-lg-6 text-md-right text-lg-right text-xl-right">
    ...
    <!-- Maybe un-needed but this is my test-fix for the copyright text and right side icons not aligning -->
    <div class="row">
      <div class="col-lg-9">
        <i class="far fa-copyright"></i>
          <!-- Using inline styles for now ... maybe more code would be needed to put it in the CSS file -->
      ...
      <div class="col-lg-3">
        <div style="color: #ffffff;float: right;">
          ...
          <a href="https://www.youtube.com/user/Xmetalfanx" target="_blank">
          <i class="fab fa-youtube fa-2x"></i></a>

          <a href="https://plus.google.com/+Xmetalfanx2014/about" target="_blank">
          <i class="fab fa-google-plus fa-2x"></i></a>
        </div>
      </div>
    </div>
  </div>
...
</div> <!-- Ends Container that is opened up in the header file -->

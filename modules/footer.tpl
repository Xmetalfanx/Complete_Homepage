...
<footer class="row col-12 pl-4 py-3 mx-0">
  <div class="col-3 d-flex">Site made with:
    ...
    <!-- HTML 5-->
    <a href="https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/HTML5" aria-label="Mozilla Developer Site for HTML5" target="_blank" rel="noopener"><i class="fa fa-html5 fa-2x"></i></a>
    
    <!-- CSS 3 -->
    <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS3" aria-label="Mozilla Developer Site for CSS3" target="_blank" rel="noopener">   <i class="fa fa-css3 fa-2x"></i></a>

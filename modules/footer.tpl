...
<footer>
  <div class="col d-block">Site made with:
    ...
    <img class="icon iconSM" src="/graphics/simpleIcons/darkBG/html5.svg" alt="HTML5 SVG">
    ...
    <img class="icon iconSM" src="/graphics/simpleIcons/darkBG/css.svg" alt="CSS SVG"><span class="hiddenAccessLinkText">Mozilla Developer Site for CSS3</span></a>
  ...
  <div class="col d-none d-lg-block text-right">
    ...
    <a href="https://gitlab.com/Xmetal" aria-label="Xmetalfanx Gitlab Page" target="_blank" rel="noopener">
      <img class="icon iconSM" src="/graphics/simpleIcons/gitlab.svg" alt="GitLab SVG">
    ...
    <img class="icon iconSM" src="/graphics/simpleIcons/darkBG/github.svg" alt="Github SVG">
    <span class="hiddenAccessLinkText">My Github Page<br/></span></a>
    ...
    <img class="icon iconSM" src="/graphics/simpleIcons/darkBG/bitbucket.svg" alt="Bitbucket SVG">
    ...
    <img class="icon iconSM" src="/graphics/simpleIcons/darkBG/twitter.svg" alt="Twitter SVG"><span class="hiddenAccessLinkText">Find me on Twitter<br/></span></a>

    <a href="https://www.youtube.com/user/Xmetalfanx" aria-label="Xmetalfanx's Youtube Page" target="_blank" rel="noopener">
    <img class="icon iconSM" src="/graphics/simpleIcons/darkBG/youtube.svg" alt="Youtube SVG"><span class="hiddenAccessLinkText">Find me on Youtube</span></a>

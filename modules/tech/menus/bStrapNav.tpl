...
<nav class="navbar navbar-static-top bg-inverse">
  <div class="navbar-header hidden-md-down">
    ...
    <div class="dropdown-menu hidden-md-up">Bleh
      ...
      <a href="/techHQ/techcenter/techCenterIndex.php" class="dropdown-item">Tech Center ( Tips/Tutorials )</a>
      <a href="/techHQ/browsers/browserIndex.php" class="dropdown-item">Web Browser</a>
      <a href="/techHQ/security/securityIndex.php" class="dropdown-item">Security</a></div>
  </div>
</nav>

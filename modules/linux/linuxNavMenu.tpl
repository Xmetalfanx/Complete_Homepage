<div id="bodyConainter">
  <div id="bodyMain">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <button type="button" data-toggle="collapse" data-target="#linuxHQNav" aria-controls="linuxHQNav" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler"><span class="navbar-toggler-icon"></span></button>
      <div id="linuxHQNav" class="collapse navbar-collapse ml-auto">
        ...
        <div class="navbar-nav ml-auto">
          ...
          <a href="/linuxHQ/apps/appIndex.php" class="nav-item nav-link">Linux Apps</a>
          <a href="/linuxHQ/tic/TICHome.php" class="nav-item nav-link">Theme/Icons/Cursors</a>
        </div>
      </div>
    </nav>

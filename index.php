  ...
  <body> 
    <div class="flexContainer">
      ...
      <div class="mainSection">
        ...
        <div class="font-weight-bold">October 28th 2018 Update</div>
        ...
        <div class="row py-5">
          ...
          <div class="col-md-6"> 
            <div class="card shadow mx-auto w-75">
              ...
              <div class="card-text text-justify p-3">
                <div class="row px-2">
                  <a href="https://github.com/Xmetalfanx/linuxThemes" target="_blank" rel="noopener"><i class="fa fa-github fa-2x text-dark" aria-hidden="true"></i></a><a href="https://gitlab.com/Xmetal/linuxThemes" target="_blank" rel="noopener"><i class="fa fa-gitlab fa-2x text-dark" aria-hidden="true"></i></a></div>

...
<div class="mx-auto my-2 shadow card w-95">
  <div class="card__header">Free Antivirus Scanners, I trust</div>
  <div class="card__body">
    <ul class="list-group list-group-flush">
      <li class="list-group-item">
        <a href="https://support.kaspersky.com/us/kscloud" target="_blank"> <img class="mr-2 icon--size32" src="/techHQ/progIcons/security/AVs/kaspersky.png" alt="Kaspersky Security Cloud graphics">Kaspersky Security Cloud </a></li>
...
<div class="mx-auto my-2 shadow card w-95">
  <div class="card__header">Free Antivirus Scanners, I am not sure about </div>
  <div class="card__body">
    <ul class="list-group list-group-flush">
    ...
    <div>Please see:
      <ul>
        ...
        <li>
          ...
          Update: Avast kills Jumpshot data-collection business after privacy concerns mount</a>
        </li>

        <div>I am not commenting on their detection rate ... that may be good enough ... it's the fact that they ever (and after public backlash they said they stopped this) sold users data in the first place.  This is suppose to be a security "app/program" company.  The fact they ever thought this was a good idea, worries me.</div><br/>

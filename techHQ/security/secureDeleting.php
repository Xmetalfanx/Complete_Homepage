<?php
	...
	$the_title = 'Xmetalfanx Security Section - Removing Data and not just Deleting';
	$the_content = <<<<EOD

  <p class="header">Security Removing Data from your computer
  </p>        
  <p class="justify">Here is a topic I forgot about putting on the site . Recently on the news they showed how when you get rid of computer, how anyone can get your information within minutes... personal records, social security numbers, tax data and more ... .Although I do not keep that sort of thing on my machine, some do... I can not tell you exactly where all of your files are to remove (all your tax info, what files have S.S. Numbers... etc) that will very by machine and the program you use... but i will give you a few bits of information 
  </p>        
  <p class="header">&quot;But I hit delete, so it must be gone&quot;
  </p>        
  <p class="justify">Now Seriously think... if that were true, HOW WOULD these &quot;un-delete programs&quot; works?... This may not be right, but it's a close example from what I know 
  </p>        
  <ul>          
    <li>            
    <p class="justify">            Picture you want a book REMOVED from the library... you take it off the shelf and put it on the table next to the trash can ....sure its off the shelf and not where it normally would be, but it's still there.... for anyone to pick up 
    </p>          
    </li>        
  </ul>        
  <p class="header">Can I ever really remove all the data? 
  </p>        
  <p>
  ...
  <p class="header">
    <a href="http://www.heidi.ie/eraser/" target="_blank">Eraser</a> - MY Favorite Drive Wiping Tool
  </p>        

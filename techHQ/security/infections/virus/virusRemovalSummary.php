<?php 
	...
	$the_title = 'Xmetalfanx Security Section - How to removal a Virus/Spyware Infection - Summary';
	$the_content = <<<EOD     
  
  
  <p class="header">Last Updated:                   
    <!-- #BeginDate format:Am1a --> September 24, 2014 10:38 PM    <!-- #EndDate --> 
  </p>      
  <p>If you have the &quot;Anti(virus/spyware) 2009&quot; Infection and what information about what it is and how to remove it,        
    <a href="fakeAV_2009.php">      please click here to go to my &quot;special page&quot; on that infection</a>. It seem MANY MANY people have been fooled and downloaded these       fake applications 
  </p>      
  <p>I am making this page to summarize the steps you should take If you think you have a virus/trojan or spyware infection<br /><br />      
    <img src="../../graphics/computer/ordinateur-16.gif" alt="Computer Smoking" width="72" height="82" class="left" /><br />      
  </p>    
  <p class="boldText">&quot;HELP, I HAVE GOTTEN A VIRUS (OR I THINK I HAVE) .. .WHAT DO I DO? &quot;
  </p>      
  <ol>        
    <li>
    <span class="boldItalics">Do not panic ..           
    </span>          
    <ul>            
      <li>when I was new to computers, I even &quot;panicked&quot; and deleted a legit file I thought was part of the infection that wasn't ...              in short, I made the problem MUCH MUCH WORSE.
      </li>          
    </ul>        
    </li>        
    <li>
    <span class="boldItalics">Realize that not all Antiviruses/Anti-spyware/Anti-Malware programs are the same as how good they are. 
    </span>        I AM NOT ASSOCIATED WITH ANY COMPANY AND ANY REVIEWS I refer to are not affiliated to  any company that produces a particular scanner.          
    <span class="maroonText">(Like a &quot;what is the most secure web browser?- IE 8 by FAR&quot; .. so called review of all the browser article          I recently saw ... in small print there is &quot;Sponsored by Microsoft&quot; ... so OF COURSE Microsoft is going to say there product is best.)          
    </span>
    </li>    
  </ol>      
  <p>&nbsp;
  ...
  <p class="center">      
    <a href="#virus">Virus/Trojan Related</a> | Spyware Related | Other &quot;Must have&quot; programs 
  </p>          
  <p class="mainProgCat">

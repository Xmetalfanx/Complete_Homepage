<?php
  ...
  $pageTitle = 'Drive Imaging and Partitioning';
  include $sitePath . "/templates/tech/baseTechSoftwareTemp.tpl";

?>
<p class="justify">
  I have recently tried a program I downloaded awhile back and alot of Linux users say they love, called <span class="text-danger">PartImage</span><span class="italics"> (think of a better Norton Ghost)</span> for more File systems.. </p>

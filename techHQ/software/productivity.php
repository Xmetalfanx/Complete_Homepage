...
?>
		...
		<ul>
		 ...
		 <li>
		  ...
		  <li>
			...
			<img src="../graphics/programs/notepad/npp.logo.80x15.png" alt="Notepad++" width="80" height="15" /></a></p>
			<p>
			  This is a Notepad replacement that will color code MANY types of code for easier readability. Many programmers would appreciate this, as its not a bloated Notepad replacement, but it just adds enough features that makes it more useful.</p>
		  </li>
		</ul>
		<h3>PDF Creators</h3>
		<ul>
		...
		<ul>
		  <li>
			...
			<img src="../graphics/programs/foxit_logo.gif" alt="Foxit PDF Reader" width="141" height="45" class="imgleft" /></a>
			** This is a free PDF Reading Program that overall, I believe is about 2 MB as opposed to   Adobe Reader's 10-30 MB ..</p>
			<p>This has many features a program like SumatraPDF does NOT HAVE, however, it seems to have gotten &quot;bloated&quot;
		...
		<ul>
		  <li>
			...
			<p>This is a COMPLETELY FREE alternative to Microsoft's Office Suite. It  may not have all the &quot;bells and whistles&quot; that MS Office has (note: my view, is if you cant figure out what those features are, then you probably &quot;didn't need&quot; them anyway), AND Open Office (like Libre Office) is 100% Free, though there may be a small charge for cooperate environments.</p>
			...
			<p>(September 2012): No Longer associated with Oracle, and a product of Apache, meaning it is once again Open Sources and being regularly updated once again, after a year of &quot;being stuck&quot; with no updates from Oracle</p>
      ...
      <!-- For widths and Heights below, use CSS in the future and remove that code in this HTML -->
			...
			<table class="center" style="width:55%;border:0;">
			  <tr>
				<td class="third"><p><img src="../progIcons/product/libreIcons/swriter_1.jpg" alt="Libre Writer Icon" width="42" height="42" class="iconsLeft" /></p>
				  <p>Word Processor </p></td>
				<td class="third"><p> <img src="../progIcons/product/libreIcons/scalc_1.jpg" alt="Libre Calc Icon" width="42" height="42" class="iconsLeft" /> </p>
				  <p>Spreadsheet</p></td>
				<td class="third"><p><img src="../progIcons/product/libreIcons/sdraw_1.jpg" alt="Libre Draw Icon" width="42" height="42" class="iconsLeft" /></p>
				  <p>&quot;Draw&quot; Program </p></td>
			  </tr>
			  <tr>
				...
				<td class="third"><img src="../progIcons/product/libreIcons/soffice_39.jpg" alt="Libre Office Math Program Icon" width="51" height="51" class="iconsLeft" />&quot;Math&quot; Program</td>
				<td class="third"><img src="../progIcons/product/libreIcons/soffice_34.jpg" alt="Libre Presantation Program Icon" width="48" height="48" class="iconsLeft" />Presentation Program</td>
			  </tr>
			</table>
			<p>***October 2012 Open Office/Libre Office Note: ***</p>
		...
		<ul>
		  ...
		  <li>
			<p><img src="../progIcons/product/docscrubber-48.png" alt="Doc Scrubber Icon" /> <a href="http://www.javacoolsoftware.com/index.html">Doc Scrubber</a></p>

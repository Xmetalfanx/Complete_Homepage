...
<div class="panel panel-default">
  <div class="panel-header">
    <img src="../progIcons/product/txtEditorIcons/AbiWord_10000.png" alt="AbiWord Icon" />
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    (see the basic description for <a href="http://www.notetab.com/notetab-light.php">Notetab Light</a> )
  </div>
</div>
      ...
      <div class="panel panel-default">
        <div class="panel-header">
          <img src="../progIcons/product/txtEditorIcons/notepad++_100.png" alt="Notepad_PlusPlus Icon" />
    			<a href="http://notepad-plus.sourceforce.net">Notepad++</a>
        </div>
      </div>
      ...
      <div class="panel panel-default">
		...
		<ul>
		  <li>
			<p class="title">
        <img src="../progIcons/product/pdf/bullzip_PDF.png" alt="Bullzip PDF Creator Icon" />
...
<h3>Office Suites</h3>
      ...
      <div class="panel panel-default">
        <div class="panel-header">
  			     <a href="http://wps.com/wps-office-personal/">Kingsoft Office/ WPS Office</a>
        </div>
        <div class="panel-body">
          ...
          <div class="panel-body">
                ...
                <div class="table-responsive">
                  <table class="table">
                    <tr>
                      <td>
                        <img src="../progIcons/product/libreIcons/swriter_1.jpg" alt="Libre Writer Icon" width="42" height="42" class="iconsLeft" />
                        <p>Word Processor </p>
                      </td>
                      <td>
                      ...
                      <td>
                        <p>
                        <img src="../progIcons/product/libreIcons/sdraw_1.jpg" alt="Libre Draw Icon" width="42" height="42" class="iconsLeft" /></p>
                        <p>&quot;Draw&quot; Program </p>
                      </td>
                    </tr>
                    <tr>
	...
	<h3>&quot;Misc&quot; Office/Productivity Programs</h3>
      ...
      <div class="panel panel-default">
        <div class="panel-header">
          <img src="../progIcons/product/docscrubber-48.png" alt="Doc Scrubber Icon" />
          <a href="http://www.javacoolsoftware.com/index.html">Doc Scrubber</a>
        </p>
        </div>
        <div class="panel-body">
          <p>&quot;Have you ever wondered what hidden information might be lurking inside your Word documents? Have you ever wondered how to access that information, and if it is possible to remove it?</p>
    			...
    			<p>Doc Scrubber can quickly and easily discover hidden data inside Word documents and can allow the painless removal of such information, sometimes referred to as &quot;metadata&quot;.  &quot; <span class="mainSiteUpdates">(Doc scrubber help file)</span>
          </p>
    			<p class="center">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body"><p>Movie Database program that is 100% free</p></div>
        </div>


        <div class="panel panel-default">
          <div class="panel-header">
            <img src="../progIcons/product/TextCrawler_32512.png" alt="Text Crawler Icon" />
            <a href="http://www.digitalvolcano.co.uk/">Text Crawler</a>
          </div>
          <div class="panel-body">
        ...
        <div class="panel panel-default">
          <div class="panel-header"><a href="http://atorg.net.ru/universal_viewer/">Universal Viewer</a>
          </div>
          <div class="panel-body">
    ...
    <div class="panel panel-default">
      <div class="panel-header">
          <a href="http://www.yankee-clipper.net/">Yankee Clipper</a>
        </div>
    </div>

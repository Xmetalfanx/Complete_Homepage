...
?>
    ...
    <ul>
      ...
      <img src="../progIcons/product/cse90_MAINICON.png" alt="CSE Validator Icon" width="36" height="36" class="iconsLeft" />
      <span class="progName">CSE HTML Validator</span></a> - Great Website Syntax Checker that catches many many mistakes in coding that other syntax checkers misses    </li>
    </ul>
    <ul>

...
<div class="card hidden-sm-down">
  <div class="card-block">
    <div class="card-text">
      <div class="row">
        <div class="col-md-5"><?php echo $softpediaIcon; ?></div>
        <div class="col-md-5"><?php echo $majorGeeksIcon; ?>s</div>
      </div>
    </div>
  </div>
</div>
...
<ul class="accordion-tabs-minimal">
            ...
            <h4>Video Players</h4>
              <div class="row">
                <div class="col-lg-3 col-md-3">
                  <?php echo $mpvIcon . $mpvHome; ?></div>
                <div class="col-lg-3 col-md-3">
                  <?php echo $smPlayerIcon . $smPlayerHome; ?> </div>
                <div class="col-lg-3 col-md-3">
  ...
  <li class="tab-header-and-content">
    ...
    <div class="tab-content">
      <div class="card">
        <div class="card-block">
          <div class="card-text">
			      <?php echo $libreOIcon . $libreOHome; ?></div>
        </div>
      </div>
    </div>
  </li>
  ...
  <li class="tab-header-and-content">
    ...
    <div class="tab-content">
		...
		<a href="http://bleachbit.sourceforge.net/">Bleachbit</a></div>
  </li>
...
<ul class="accordion-tabs-minimal">
  ...
  <li class="tab-header-and-content">
    ...
    <div class="tab-content">
      <div class="row">
        <div class="col-lg-5">
          <a href="http://audacious-media-player.org/">Audacious</a></div>
        <div class="col-lg-5">
          <div>DeadBeef</div>
        </div>
      </div>

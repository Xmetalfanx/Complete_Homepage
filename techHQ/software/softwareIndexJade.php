...
<div class="row"> 
  ...
  <div class="col-lg-6">
    ...
    <?php echo $majorGeeksIcon; ?>s
  </div>
</div>
<div>Cross Platform
  <div class="panel panel-default">
    <div class="panel-heading">Graphics Applications s</div>
    <div class="panel-body">
      <div class="row">
        ...
        <div class="col-lg-6"><?php echo $gimpIcon . echo $gimpHome; ?>
...
<div class="panel panel-default">
  ...
  <div class="panel-body"><img src="/techHQ/progIcons/security/cleaners/bleachbit_1.jpg" alt="Bleachbit Icon"/><a href="http://bleachbit.sourceforge.net/">Bleachbit</a></div>
</div>
...
<div class="panel panel-default">
  <div class="panel-heading">Productivity Programs</div>
  <div class="panel-body">
    <h3>Windows </h3>
    <p>PDF Readers - Adobe Acrobat Reader alternatives
      <div class="row"> 
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <h3>Windows
      <div class="row">
        <div class="col-sm-4"><img src="/techHQ/progIcons/security/AVs/1589__Avast!FreeAntivirus5_icon.png" alt="Avast Icon"/><a href="http://www.avast.com/free-antivirus-download">Avast </a></div>
        <div class="col-sm-4"><img src="/techHQ/progIcons/security/malware/mbam_IDI_MAIN.png" alt="Malwarebytes Icon"/><a href="http://www.malwarebytes.org/">Malwarebytes Anti-Malware</a></div>
        <div class="col-sm-4"><a href="https://www.emsisoft.com/en/software/eek/">Emsisoft Emergency Toolkit</a></div>
      </div>
      <h3>Cache/Temp File Cleaners
        <div class="row">
          <div class="col-sm-6"><?php echo $ccleanerIcon; echo $ccleanerHome;  ?></div>
          <div class="col-sm-6"><?php echo $CCEnhIcon; echo $CCEnhHome; ?>
            <div>A sort of &quot;database&quot; of what to clean for programs that support it  (To add more removable items then the programs default)</div>
          </div>
        </div>
      </h3>
    </h3>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <h3>Windows
      <div class="row"> 
        <div><a href="https://www.partitionwizard.com/free-partition-manager.html">Minitools Partition Manager Freeware Edition</a></div>
      </div>
      <h4>System Suite
        <div class="row">
          <div class="col-lg-4"></div><?php echo $glaryIcon; echo $glaryHome; ?> 
          <div class="col-lg-4"></div><?php echo  $wiseCareIcon; echo $wiseCareHome; ?>
        </div>
      </h4>
    </h3>
  </div>

  ...
  <div class="card__body">
    <figure>
      <a href="https://www.khanacademy.org/" target="_blank" rel="noreferrer" aria-label="Link to Khan Academy">
        <img class="d-none d-md-block lazyload img-fluid" data-src="/techHQ/graphics/khan-academy.svg" alt="Khan Academy website Graphic" />
    ...
    <figure>
      <a href="https://www.digitalocean.com/community/" target="_blank" rel="noreferrer" aria-label="Link to Digital Ocean">
        <img class="d-none d-md-block lazyload img-fluid"  data-src="/techHQ/graphics/digitalOcean.png" alt="Digital Ocean website Graphic" />
    ...
    <figure>
      <a href="http://www.kristakingmath.com/" target="_blank" rel="noreferrer" aria-label="Link to Krista King's Math related site">
        <img class="d-none d-md-block lazyload img-fluid" data-src="/graphics/kking_logo.png" alt="Krista King Math Site website graphics">
    ...
    <figure>
      <a href="http://www.scienceandmath.com/" target="_blank" rel="noreferrer" aria-label="Link to ScienceandMath.com">
        <img class="d-none d-md-block lazyload" data-src="/graphics/mathandscience.jpg" alt="Science and Math.com website graphics">
    ...
    <h4>Learning the Commandline</h4>
     ...
     <figure>
      <a href="https://linuxjourney.com/" target="_blank">
        <img class="d-none d-md-block lazyload img-fluid" data-src="../graphics/linux-journey.png" alt="Linux Journey website graphic" />

    ...
    <div class="row text-center">
      ...
      <div class="col-lg-3 col-md">
        <a href="https://linuxacademy.com/" target="_blank" rel="noreferrer">
          <img class="mx-auto d-none d-md-block lazyload" data-src="/graphics/linuxAcademy.png" alt="Linux Academy Graphic">Linux Academy
        </a>
      </div>
      <div class="col-lg-3 col-md">
        <a href="https://www.digitalocean.com/community/" target="_blank" rel="noreferrer">
          <img class="mx-auto d-none d-md-block lazyload"  data-src="/techHQ/graphics/digital-ocean.png" alt="Digital Ocean Graphic">Digital Ocean
        </a>
      </div>
      <div class="col-lg-3 col-md">
        <a href="http://www.kristakingmath.com/" target="_blank" rel="noreferrer">
          <img class="mx-auto d-none d-md-block lazyload" data-src="/graphics/kking_logo.png" alt="Krista King Math Site graphics">Krista King Math Tutor
        </a>

...
<p class="underlineBold">Media Players</p>
       
        <p class="justify"> Most Audio Playing programs can handle errors in the header of an mp3. One of the best 
        players, Winamp, Does not seem to have any problems reading these files; however, I have heard of some Mp3 
        Hard drives (portable mp3 players then can store perhaps thousands of mp3s.... really expensive from what I
        remember reading about them awhile back...) Normalizing an audio track will lower the levels of tracks that 
        have volumes too high (those stereos at Best Buy or Circuit City, where when they hit even 1/2 as loud as 
        the total level is, the audio quality seems to go &quot;south&quot; really fast). On the other hand it can also 
        raise the level of audio tracks recorded that are too low. Remember, Normalizing will adjust the level of 
        the volume.... it has nothing to do with the improving of audio Quality itself </p>

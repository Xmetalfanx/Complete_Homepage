...
<p><img src="/techHQ/graphics/computer/ordinateur-26.gif"/></p>
<p class="well">
  ...
  IN here too, but I needed something to fill out the main menus
  on the top of the page, so that remains a different section.
</p>
<p>I know its confusing to have an OS based Main section (LinuxHQ) and a non-OS based section, but alot of
  these tips and tricks are not specific to Windows or Linux (I have not uploaded ... say the content on ID3
   tag lookup under Linux ... YET) ... THE SAME concept is going to be applied to the Software Section ...

...
<div class="card border-primary">
  ...
  <div class="card-text"> 
    ...
    <a href="/techHQ/browsers/addons/firefox/interfaceAddons.php">Interface Related</a><br/>
    <a href="/techHQ/browsers/#">Backing up Browser Data</a><br/>
    <a href="/techHQ/browsers/tinyurl.php">URL Shortening</a></div>
</div>
...
<div class="card border-primary">
  ...
  <div class="card-text">
    ...
    <a href="/techHQ/browsers/adblocking/">List of Common Filter lists (strong Static Filters)</a>
    <h5 class="bg-primary text-white">More Advanced Topics </h5>
    ...
    <ul>
      <li> 
      <a href="/techHQ/browsers/adblocking/noopExplained.php">What on earth is a &quot;noop filter&apos;?</a></li>
      <li><a href="/techHQ/browsers/adblocking/">How to &quot;use&quot; Noop Rules</a></li>
    </ul>
    
    <h5 class="bg-primary text-white">Umatrix Specific </h5>
    ...
    <h5 class="bg-primary text-white">More Ublock Tasks</h5>

...
<div>
  ...
  <div class="card">
    <div class="card-header bg-primary text-white">Multimedia Related</div>
      ...
      <a href="/techHQ/software/multimedia/media_players_audio.php">Media Players <em>Audio</em><br/></a>
      <a href="/techHQ/software/multimedia/media_players_video.php">Media Players <em>Video </em><br/></a>

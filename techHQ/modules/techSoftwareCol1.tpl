...
<div class="card">
  <div class="card-header"><a href="/techHQ/software/multimedia.php">Multimedia Related</a></div>
  <div class="card-block">
    <div class="card-text"><a href="/techHQ/software/multimedia/audio.php">Audio</a><br/>
      <a href="/techHQ/software/multimedia/graphics.php">Graphics</a><br/><a href="/techHQ/software/multimedia/media_players_audio.php">Media Players <em>Audio</em></a><a href="/techHQ/software/multimedia/media_players_video.php">Media Players <em>Video </em></a><br/><a href="/techHQ/software/multimedia/videoPrograms">Video Related Programs</a><br/></div>
  </div>
</div>
...
<div class="card">
  <div class="card-header"> <a href="/techHQ/software/securityPrograms.php">Security Related</a></div>
  <div class="card-block">
    <p class="card-text"><a href="/techHQ/software/security/virusANDMalwareScanners.php">Antivirus and Antimalware</a><br/><a href="/techHQ/software/security/cleaners.php">System Cleaners</a><br/><a href="/techHQ/software/security/firewalls.php">Firewalls</a><br/></p>
  </div>
</div>

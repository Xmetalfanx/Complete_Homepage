...
<div id="browser-frontpage">
  ...
  <div id="addons">
    ...
    <div class="jc-start">
      <div class="addon"><img class="icon" src="/techHQ/browsers/graphics/icons/ublock-origin.svg" alt="Ublock Origin SVG Icon">
      ...
      <div class="addon"><img class="icon" src="/techHQ/browsers/graphics/icons/bit-warden.svg" alt="Bit Warden SVG Icon">

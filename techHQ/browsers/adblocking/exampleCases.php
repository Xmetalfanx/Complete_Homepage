...
<div class="card shadow">
  <div class="card__header">Allowing a connection from a third party domain, on a site, BYPASSING any static filter</div>
...
<div class="card shadow">
  <div class="card__header">Overiding a global Block (Red), Dynamic filter</div>
  <div class="card-text p-3">

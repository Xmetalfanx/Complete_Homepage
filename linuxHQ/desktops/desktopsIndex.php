...
<div id="LinuxSection">
  <div class="card">
    <div class="card-block">
      ...
      <div class="card-text hidden-xs hidden-sm">
        <div class="screenshots"><?php echo $budgieSS1 . $budgieSS2 . $budgieSS3; ?></div>
  ...
  <div class="card">
    <div class="card-block">
      ...
      <div class="card-text hidden-xs hidden-sm">
        ...
        <div class="font-weight-bold">Distros that feature:</div><?php echo "Linux Mint" . $fedoraHOME . "Arch"; ?>
      </div>
  ...
  <div class="card">
    <div class="card-block">
      ...
      <div class="card-text">
        <div class="screenshots"></div><?php echo $fedoraGnome_SS1 . $suseGnome_SS1; ?>
  ...
  <div class="card">
    <div class="card-block">
      ...
      <div class="card-text">
        ...
        <div class="screenshots"><?php echo $mintMateSS1 . $mintMateSS2; ?></div>
        <div class="home"><a href="http://mate-desktop.org/" target="_blank">Mate Homepage</a>
          ...
          <div class="linuxContainer">
            <div class="font-weight-bold">CPU speed:</div>512MB
            <div class="font-weight-bold">Memory:</div>800MHz
  ...
  <div class="card">
    <div class="card-block">
      ...
      <div class="card-text">
        <div class="screenshots"><?php echo $antergosKDE1 . $manjaroKDE5 . $kaosKDE_SS1; ?>
          <div class="font-weight-bold"><a href="https://www.kde.org/workspaces/plasmadesktop/" target="_blank"></a>Plasma 5 (aka &apos;KDE 5&apos;)
            <div class="linuxContainer"><span class="title">Distros that feature:</span><?php echo $antergosHOME, $archHOME, $suseHOME , $fedoraHOME , $kubuntuHOME , $mintHOME; ?></div>
            <div class="linuxContainer"><span class="title">CPU speed:</span>1GHz<span class="title">Memory:</span>615MB<span class="title">My Comments:</span>I am not sure if these are KDE4 or Plasma 5 specs listed above though I would say at LEAST 2GB of RAM and 1.7GHZ+ for the processor.</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="card">
    <div class="card-block">
      ...
      <div class="card-text">
        <div class="screenshots"><?php echo $manjaroXFCE1 . $xubuntuSS1; ?>
          <div class="linuxContainer">
          ...
          <div class="linuxContainer">
            ...
            <div class="font-weight-bold">Memory for Comfortable USE:</div>300Mhz<span class="title">My Comments:</span>I'd say it may run at those specs above, though my thinking is at least 512MB of RAM to 768MB MINIMUM and maybe oh ...  1GHz for "regular" usage of what you'd probably want to do
          </div>
        </div>
      </div>
    </div>

...
<div class="row">
  <div class="card" style="width: 30%;margin-right: 20px;">
    ...
    <div class="card-body">
      ...
      <p class="card-text">
        <div class="font-weight-bold">Some distros that Feature:</div>
         Ubuntu, Solus Gnome, OpenSuse, Arch/Antergos, Fedora 
      </p>
  ...
  <div class="card" style="width: 30%;margin-right: 20px;">
    ...
    <div class="card-body">
      ...
      <a href="http://www.linuxmint.com" target="_blank" class="btn btn-primary">
          Linux Mint Homepage 
      </a>
    </div>
  </div>
  ...
  <div class="card" style="width: 30%;margin-right: 20px;">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Some Distros that feature: KDE Neon, Kubuntu,  Arch, OpenSuse, Fedora/Korora</p>
       <a href="https://neon.kde.org/" target="_blank" class="btn btn-primary">
          KDE Neon Homepage 
      </a>
      <a href="https://kubuntu.org/" target="_blank" class="btn btn-primary">
          Kubuntu Homepage 
      </a>
      <br /><br />
       <a href="https://kaosx.us/" target="_blank" class="btn btn-primary">
          KaOS Homepage 
      </a>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="card" style="width: 30%;margin-right: 20px;">
    ...
    <div class="card-body">
      ...
      <a href="https://solus-project.com/download/" target="_blank" class="btn btn-primary">
          Solus Homepage 
      </a>
...
<div class="row">
  ...
  <div class="card" style="width: 30%;margin-right: 20px;">
    ...
    <div class="card-body">
      ...
      <p class="card-text">
        ...
        <div class="font-weight-bold">Some Distros that Feature:</div>
        Linux Mint, Ubuntu Mate, Solus Mate  
      </p>

      <a href="http://ubuntu-mate.org/" target="_blank" class="btn btn-primary">
  ...
  <div class="card" style="width: 30%;margin-right: 20px;">
    ...
    <div class="card-body">
      ...
      <a href="http://lubuntu.net/" target="_blank" class="btn btn-primary">Lubuntu Homepage</a>
      <a href="https://peppermintos.com/about/" target="_blank" class="btn btn-primary">Peppermint Homepage</a>

...
<?php include $_SERVER['DOCUMENT_ROOT'].('/linuxHQ/modules/officalHP.php'); ?>

<?php

  $title = 'Desktop Envirnment Section';

  $content = <<<EOD

		 <div id="DESection">
			<div class="DEName"><a href="https://solus-project.com/budgie/">Budgie</a></div>

			<div class="DEs">$budgie1  $budgie2  $budgie3</div>
			<div class="home"></div>
			<div class="DEFeature">
		...
		<div id="DESection">
			<div class="DEName"><a href="http://developer.linuxmint.com/">Cinnamon</a></div>
			<div class="DEs">$mintCin1  $fedoraCinn1 </div>
		        <div class="DEFeature">
		...
		<div id="DESection">
			<div class="DEName"><a href="https://www.gnome.org/">Gnomeshell/Gnome 3</a></div>
			<div class="DEs">$fedoraGnome1  $suseGnome1</div>
			<div class="home"></div>

			<div class="DEFeature">
				<span class="title">Distros that feature:</span> $archHOME . $fedoraHOME . $suseHOME
			</div>
			<div class="DESpecs">
		...
		<div id="DESection">
			...
			<div class="DEs">$mintMate1  $mintMate2</div>
			<div class="home"></div>
			<div class="home">
			...
			<div class="DEFeature">
				<span class="title">Distros that Feature:</span> $UMateHome  $fedoraHOME  $mintHOME
			</div>
		...
		<div id="DESection">
		   <div class="DEName">
			...
			<div class="DEs">$antergosKDE1  $manjaroKDE5  $kaosKDE1</div>
			<div class="home">
				<span class="title">
		...
		<div id="DESection">
			<div class="DEName"><a href="http://www.xfce.org/">XFCE</a></div>
			<div class="DEs">$manjaroXFCE1 . $xubuntu1</div>
			<div class="home"><a href="http://www.xfce.org/">XFCE</a></div>
		...
		<p>
		     <a href="https://renewablepcs.wordpress.com/about-linux/kde-gnome-or-xfce/?_utm_source=1-2-2"
			target="_blank">

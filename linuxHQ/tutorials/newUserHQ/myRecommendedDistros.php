<?php
  ...
  ?>
	...
	<p>I would NOT USE any &ldquo;fake Linux&rdquo; (say installing Linux INSIDE of Windows, which takes away the point of Linux in the first place).   I want to be clear a new users does not need to try all of these but if you try one of these and do not like it or something goes wrong ... there are other options </p>
	...
	<div class="card">
	  <div class="card-block">
	    ...
	    <div class="card-text">
	      <div class="boldUnderline"><img src="/linuxHQ/graphics/icons/lite.png" width="90" height="90" alt="Linux Lite Icon"/></div>
	    </div>
	  </div>
	</div>
	<div class="card">
	...
	<p>These are pretty easy to understand as basically its just the first part of the DE in question + "buntu"
	  <p>Examples
	    <ul>
	      <li>Kubuntu = the KDE DE + &ldquo;buntu&rdquo;</li>
	      <li>Lubuntu = LDXE DE + &ldquo;buntu&rdquo;</li>
	      <li>Xubuntu = XFCE  	DE + &ldquo;buntu&rdquo;</li>
	    </ul>
	  </p>
	</p>

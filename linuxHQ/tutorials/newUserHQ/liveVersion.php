<?php
	...
	<p>In fact, in many distributions <em>(don't worry if you do not know what this is, yet ... I am getting to answering that)</em>, running the Live Version is a good way to see if it supports your hardware.</p>

	<p>If everything plays <em>( say your graphics card plays videos and your favorite Mp3s play)</em> , then those same things will be fine when you INSTALL the distro in question.</p>


	<h2>Another way Linux (installed or not) can be VERY helpful</h2>
	...
	<p>This can be <em>(example your in a rush and have to get to a report or other document on your hard drive, &quot;RIGHT NOW&quot;)</em> … you can “instantly get” to your data and then trouble the computer (in this case with Microsoft Windows) issue later.</p>


	<h3>Deciding you want to install</h3>

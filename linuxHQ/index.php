  ...
  <div class="primary-content">
    ...
    <div class="card w-80">
      ...
      <div class="card__body"> Hello, I'd like to give a little background about my  experience with Linux, before you start browsing my site, to get a sense for where I am coming from. For a number of years now , I have been using Linux to some degree, and  have been using it more and more, while using  Windows less and less.
        ...
        <img class="d-none d-md-block thumbnails-fluid--sm" src="/linuxHQ/screenshots/ubuntu/kubuntu.png" alt="Kubuntu 18.04 slide">
    ...
    <div class="card w-80">
      ...
      <div class="card__body">
        ...
        <img class="float-left pt-1 d-none d-md-block thumbnails-fluid--sm" src="/linuxHQ/screenshots/ubuntu/cinnamonMint.png" alt="Linux Mint slide">
        ...
        <img class="d-none d-md-block thumbnails-fluid--sm" src="/linuxHQ/screenshots/solus/thumbnails/solusbudgie_tn.png" alt="Solus Budgie slide">

...
<div class="primary-content">
  <div class="card">
    ...
    <div class="card__body">
      ...
      <img class="d-none d-md-block thumbnail-fluid--sm" src="/linuxHQ/screenshots/ubuntu/kubuntu.png" alt="Kubuntu 18.04 screenshot">
    </div>
  </div>
  
  <div class="card">
    <div class="card__header themeColorAccent">My Goal</div>
    <div class="card__body">
      <img class="float-left pt-1 d-none d-md-block thumbnail-fluid--sm" src="/linuxHQ/screenshots/ubuntu/cinnamonMint.png" alt="Linux Mint screenshot" loading="lazy">
      <div> 
          Showing Tutorials, My reviews (as well as others), and sites that have helped me over	the years, is TRUE goal I have with this section. The Linux related ideas I came up with to add to the main site started to get way out of hand to put in a "small section" so that's when I decided to do the split into TechHQ (former Windows Section ... and still has some cross-platform stuff) and LinuxHQ. This section has info on:</Showing><br>
        <ul>
      ...
      <img class="d-none d-md-block mx-auto thumbnail-fluid--sm" src="/linuxHQ/screenshots/solus/thumbnails/solusbudgie_tn.png" alt="Solus Budgie slide" loading="lazy">
    </div>
  </div>

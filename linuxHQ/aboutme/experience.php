...
// My Linux experience file
      ...
      $AntergosExp = 'Since mid-Summer 2014 ... pretty much constant';
      ...
      // Ubuntu based
      $mintExp = 'Linux Mint 14, 15, 16, 17.x, and 18.x (Mostly all of the Desktops
      for each version)';
      $ubuntuExp = ' 9.04, 9.10, 10.04, 14.04 LTS, 16.04 LTS ' ;
      $kubuntuExp = '14.04 LTS, 14.10, and 15.10 beta';
      $lubuntuExp = '14.04 LTS, 14.10';
      $xubuntuExp = '14.04 LTS, 14.10';
      $lliteExp = ' 1.8, 2.0, 2.2, 2.4, and 2.6, 3.0 ';
      $eOSExp = 'Luna, Freya ';
      $DeepinExp = 'Started with 14.04 ... then 14.04.1... 14.04.2 ';
      $ChaletExp = 'A Few Weeks at the start of 2015';

      // Debian based
      $debianExp = '7.0, 7.5, (including installing "stable", than  manually updating to "Testing" and even updating from that "Testing" to "Unstable"), 9.x  ';
      ...
      $fedoraExp = 'Version 20 for a year, 21, 22, 23, 24. 25. 26 ';

...
<div class="card">
  <div class="card-header bg-primary text-white">NEW USER HEADQUATERS</div>
  ...
  <h4>FAQ&apos;s</h4>
    ...
    Linux &quot;Myths&quot; /<br/>Misconceptions<br/>
...
<div class="card">
  <div class="card-header bg-primary text-white">Linux vs Windows</div>
    ...
    <a href="/linuxHQ/tutorials/newUserHQ/linuxCons.php">Linux Cons </a>
</div>

<div class="card">
  <div class="card-header bg-primary text-white">Tutorials</div>
  <h5>Overall </h5>

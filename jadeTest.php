...
<html lang="en">
  ...
  <body> 
    <nav class="navbar narbar-inverse">
      ...
      div.navbar-header 
         button.navbar-toggle.collapsed(type="button", data-toggle="collapse", data-target="#bs-example-navbar-collapse-1", aria-expanded="false")
            ...
            span.icon-bar
            span.icon-bar
         a.navbar-brand(href="http://xmetal.x10.mx") Xmetal's Homepage 
      
         // Collect the nav links, forms, and other content for toggling -->
      -->
      <div class="collapse">navbar-collapse#bs-example-navbar-collapse-1
        <ul class="nav">navbar-nav  
          <li class="active">a(href='/linuxHQ/index.php') Linux HQ span.sr-only (current)</li>
          <li>a(href='/techHQ/index.php') Tech HQ</li>
        </ul>
      </div>
    </nav>
    <div class="container">
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-body">
              <p>R.I.P. Midfngr - Please visit <img src="/graphics/midfngr.jpg" alt="midfngr thumbnail"/><a href="https://www.youtube.com/user/midfingr/undefined" target="_blank"> Midfngr's Youtube Channel</a></p>
            </div>
          </div>
          <div class="panel panel-default">
            <div class="panel-header">ATTENTION!</div>
            <div class="panel-body">
    ...
    </div><?php include $sitePath . "/modules/socalMediaIcons.tpl"; ?>
  </body>
  <footer> 
    <div class="val">Validation Gifs Here </div>
    <div class="copyright">Xmetal/Xmetalanx 2013-*</div>
